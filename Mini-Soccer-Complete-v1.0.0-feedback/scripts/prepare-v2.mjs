...
const runV23Transform=async()=>{await run("v23-gameplay-transform-final.mjs");await run("v23-runtime-hotfix.mjs")};
const runV23=async()=>{await runV22();await runV23Transform()};

if(version.includes('GAME_VERSION = "2.3.0"')){
  await runV23Transform();

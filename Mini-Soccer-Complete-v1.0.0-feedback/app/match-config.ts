export type PublicMatchFormat = 4|5|6;
...
export const MATCH_FORMATS:Record<MatchFormat,MatchConfig>={
  ...
  4:{players:4,label:"4v4 Rápido",recommended:false,pitchWidth:1512,pitchHeight:821,minTeammateRatio:.096,supportRatio:.17,rotationFreedom:.92,structureDiscipline:.62,transitionTempo:1.05,periodSeconds:135,formation:[{x:73,y:50,role:"DEL"},{x:43,y:24,role:"MED"},{x:43,y:76,role:"MED"},{x:9,y:50,role:"ARQ"}]},
  5:{players:5,label:"5v5 Recomendado",recommended:true,pitchWidth:1687,pitchHeight:899,minTeammateRatio:.105,supportRatio:.19,rotationFreedom:.72,structureDiscipline:.79,transitionTempo:.98,periodSeconds:150,formation:[{x:78,y:50,role:"DEL"},{x:55,y:25,role:"MED"},{x:55,y:75,role:"MED"},{x:31,y:50,role:"DEF"},{x:8,y:50,role:"ARQ"}]},
  6:{players:6,label:"6v6 Táctico",recommended:false,pitchWidth:1898,pitchHeight:994,minTeammateRatio:.10,supportRatio:.185,rotationFreedom:.48,structureDiscipline:.92,transitionTempo:.91,periodSeconds:165,formation:[{x:79,y:50,role:"DEL"},{x:55,y:27,role:"MED"},{x:55,y:73,role:"MED"},{x:31,y:30,role:"DEF"},{x:31,y:70,role:"DEF"},{x:7,y:50,role:"ARQ"}]},
};

export const PUBLIC_FORMATS:PublicMatchFormat[]=[4,5,6];

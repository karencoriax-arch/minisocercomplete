...
test("pass target never selects an opponent even if closer to aim",()=>{const players=[{x:0,y:0,vx:0,vy:0,team:1,r:18},{x:-190,y:20,vx:0,vy:0,team:1,r:18},{x:-70,y:0,vx:0,vy:0,team:0,r:18}];assert.equal(chooseLocalPassTarget(players,0,3,0,{x:-1,y:0}),1)});
...
test("switch chooses nearest outfield teammate to ball",()=>{const players=[{x:500,y:400,vx:0,vy:0,team:1,r:18},{x:90,y:100,vx:0,vy:0,team:1,r:18},{x:60,y:60,vx:0,vy:0,team:1,r:18,role:"ARQ"},{x:101,y:100,vx:0,vy:0,team:0,r:18}];assert.equal(localSwitchCandidate(players,0,4,0,{x:100,y:100}),1)});
